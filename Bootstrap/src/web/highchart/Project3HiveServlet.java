...
/**
 * Servlet implementation class Project3HiveServlet
 */
@WebServlet({ "/Project3HiveServlet", "/hive33" })
public class Project3HiveServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
	 Connection con;
	   Statement stmt;
	       
	    public Project3HiveServlet() {
	        super();
	      try {
	   ...
	   protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		   ...
		   try {
			   ...
			   String sqlmoon4;
			   String memid;
			   sqlmoon1 = "select p.genrenm, count(*) from re_info r, mem_info m,prf_detail p where m.memid=r.memid and p.mt20id=r.mt20id and p.mt20id in(select mt20id from re_info where memid in (select memid from mem_info where mempa1 in (select p.prfnm from re_info r,prf_detail p where r.mt20id=p.mt20id and r.memid='";
