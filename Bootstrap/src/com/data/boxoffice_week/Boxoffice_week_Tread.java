...
public class Boxoffice_week_Tread extends Thread {
  ...
  public void run() {
    ...
    try {
      ...
      String urlAddr = "http://www.kopis.or.kr/openApi/restful/boxWeekMonthly?service=9980fac33e384b6fbb7d7917b9fab551&ststype=week&catecode=YK";
    ...
    try {
      if (xml2 != null) {
        ...
        Boxoffice_week prf =new Boxoffice_week (itemValue,itemValue1,itemValue2,itemValue3,itemValue4,itemValue5,itemValue6,itemValue7,itemValue8,itemValue9,itemValue10);
