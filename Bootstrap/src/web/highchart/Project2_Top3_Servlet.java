...
/**
 * Servlet implementation class Project2_Top3_Servlet
 */
@WebServlet({ "/Project2_Top3_Servlet", "/hive222" })
public class Project2_Top3_Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
	   Connection con;
	   Statement stmt;
	       
	    public Project2_Top3_Servlet() {
	        super();
	      try {
	   ...
	   protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		   ...
		   try {
			   ...
			   String sqlmoon4;
			   String memid;
			   sqlmoon1 = "select poster, prfnm from(select distinct p.poster, p.prfnm, p.totnmrs from re_info r, mem_info m,prf_detail p where m.memid=r.memid and p.mt20id=r.mt20id and m.memjob=(select distinct m.memjob from re_info r, mem_info m where m.memid=r.memid and r.memid='";
