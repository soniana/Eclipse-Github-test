        ...
        <header id="top-bar" class="navbar-fixed-top animated-header">
            <div class="container">
                ...
                <nav class="collapse navbar-collapse navbar-right" role="navigation">
                    <div class="main-menu">
                        <ul class="nav navbar-nav navbar-right">
                            <li><a href="main.show#about" >이달의 추천공연</a></li>
                            <li><a href="main.show#works" >이달의 공연순위</a></li>
                            <!-- <li><a href="about.html">About</a></li> -->
                            <!-- <li><a href="service.html">Service</a></li> -->
                            <li class="dropdown">
                                <a href="main.show#feature" >이달의 최신공연<span class="caret"></span></a>
                                <div class="dropdown-menu">
                                    <ul>
                                        <li><a href="404.html">뮤지컬</a></li>
                                        <li><a href="404.html">연극</a></li>
                                        <li><a href="gallery.html">오페라/클래식</a></li>
                                        <li><a href="gallery.html">무용/발레</a></li>
                                        <li><a href="gallery.html">국악/복합</a></li>
                                    </ul>
                                </div>
                            </li>
<!--                             <li class="dropdown">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="block">
                                        ...
                                        <p class="wow fadeInDown" data-wow-delay=".5s" data-wow-duration="300ms">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nobis, possimus commodi, fugiat magnam temporibus vero magni recusandae? Dolore, maxime praesentium.</p>
