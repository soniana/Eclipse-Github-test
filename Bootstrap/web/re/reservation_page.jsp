        ...
        <section id ="register" class="register">  
	            ...
	            <form class="form-horizontal" role="form" name="formname">
		                ...
		                <div class="form-group" id="leftrow">
		                    ...
		                    <div class="col-sm-9">
		                        <input type="text" id="id" name="memid" class="form-control" value="${loginmem.memid}" readonly>
		              		</div>
		                </div>	 
         				  <div class="form-group" id="leftrow">
		                    <div class="col-sm-3 control-label">
		                    ...
		                    <div class="col-sm-9">
		                        <input type="text" id="id0" name=mt20id class="form-control" value="<%=request.getParameter("mt20id")%>" readonly />
		        		    </div>
		                </div>                
		                    ...
		                    <div class="col-sm-9">
		                        <input type="text" id="id2" name="prfnm" class="form-control" value="<%=request.getParameter("prfnm")%>" readonly/>
		        			</div>
		                </div>
                 		...
                 		<div class="form-group" id="leftrow">
		                    ...
		                    <div class="col-sm-9">
		                        <input type="text" id="56" name="mt10id" class="form-control" value="<%=request.getParameter("mt10id")%>" readonly />
		                    </div>
		                </div>
		                ...
		                <div class="form-group" id="leftrow">
		                    ...
		                    <div class="col-sm-9">
		                        <input type="text" id="56" name="fcltynm" class="form-control" value="<%=request.getParameter("fcltynm")%>" readonly />
		                    </div>
		                </div>
             		    ...
             		    <div class="form-group" id="leftrow">
                			 <div class="col-sm-3 control-label">
                		       ...
                		       <div class="col-sm-9">	 
      						  <input type="text" id="dtp1" name="seldate" class="form-control" placeholder="날짜선택">
		                    </div>
		                </div>
                	   ...
                	   <div class="form-group" id="leftrow">
                		...
                		<div class="form-group" id="leftrow">
		                    <div class="col-sm-3 control-label">
		                    	...
		                    	<div class="col-sm-9">	 
		                    	<select name="seattype" id="seattype" class="form-control" onchange="calculateTotal()">
                  				<option value="None">좌석선택</option>
								<option value="S석">S석</option>
								<option value="R석">R석</option>
                		...
                		<div class="form-group" id="leftrow">
		                    <div class="col-sm-3 control-label">
		                    	<label class="control">관람인원</label>
		  						...
		  						<div class="col-sm-9">
		                    	<input type="text" name="people" class="form-control" id="people" onchange="calculateTotal()">
		               			</div>
         	          ...
         	          <fieldset>
						...
						<tr align=center>
							...
							<div>
							<input type="button" id="button" class="button-class" value="예매완료" onclick="checknadd(this.form);" style="width:150px; margin-bottom:50px;">
							</div>
