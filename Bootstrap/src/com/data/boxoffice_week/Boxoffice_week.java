...
public class Boxoffice_week {
	...
	public String toString() {
		return "Boxoffice_week [area=" + area + ", prfdtcnt=" + prfdtcnt + ", nmrs=" + nmrs + ", prfpd=" + prfpd
				+ ", cate=" + cate + ", prfplcnm=" + prfplcnm + ", prfnm=" + prfnm + ", rnum=" + rnum + ", seatcnt="
				+ seatcnt + ", poster=" + poster + ", mt20id=" + mt20id + "]";
	}
	public Boxoffice_week(String area, String prfdtcnt, String nmrs, String prfpd, String cate, String prfplcnm,
