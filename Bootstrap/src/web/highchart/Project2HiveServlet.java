...
/**
 * Servlet implementation class Project2HiveServlet
 */
@WebServlet({ "/Project2HiveServlet", "/hive22" })
public class Project2HiveServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
	 Connection con;
	   Statement stmt;
	       
	    public Project2HiveServlet() {
	        super();
	      try {
	   ...
	   protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		   ...
		   try {
			   ...
			   String sqlmoon4;
			   String memid;
	           sqlmoon1="select p.genrenm, count(*) from re_info r, mem_info m,prf_detail p where m.memid=r.memid and p.mt20id=r.mt20id and m.memjob=(select distinct m.memjob from re_info r, mem_info m where m.memid=r.memid and r.memid='";
